...
foreach(_expectedTarget Rint Thread MultiProc New vectorDict listDict forward_listDict dequeDict mapDict map2Dict unordered_mapDict multimapDict multimap2Dict unordered_multimapDict setDict unordered_setDict multisetDict unordered_multisetDict complexDict valarrayDict Cling rootcling rlibmap Core rmkdepend MathCore MathMore Matrix Minuit Fumili Physics MLP Quadp Foam Smatrix SPlot GenVector Genetic Hist HistPainter Spectrum SpectrumPainter Hbook Tree TreePlayer TreeViewer RIO SQLIO XMLIO Net RootAuth Krb5Auth SrvAuth rootd Gpad Graf Postscript GX11 GX11TTF ASImage ASImageGui Graf3d X3d Eve RGL GLEW FTGL Gviz3d Gui Ged FitPanel GuiBld GuiHtml Recorder SessionViewer Proof ProofPlayer ProofDraw ProofBench pq2 Html EG VMC Geom GeomBuilder GeomPainter Gdml root MemStat rootn.exe roots.exe ssh2rpd xpdtest root.exe proofserv.exe hadd rootnb.exe g2root h2root PyROOT JupyROOT RMySQL RSQLite TMVA TMVAGui RooFitCore RooFit RooStats)
...
# Create imported target MultiProc
add_library(MultiProc SHARED IMPORTED)

# Create imported target New
add_library(New SHARED IMPORTED)

# Create imported target vectorDict
add_library(vectorDict SHARED IMPORTED)

# Create imported target listDict
add_library(listDict SHARED IMPORTED)

# Create imported target forward_listDict
add_library(forward_listDict SHARED IMPORTED)

# Create imported target dequeDict
add_library(dequeDict SHARED IMPORTED)

# Create imported target mapDict
add_library(mapDict SHARED IMPORTED)

# Create imported target map2Dict
add_library(map2Dict SHARED IMPORTED)

# Create imported target unordered_mapDict
add_library(unordered_mapDict SHARED IMPORTED)

# Create imported target multimapDict
add_library(multimapDict SHARED IMPORTED)

# Create imported target multimap2Dict
add_library(multimap2Dict SHARED IMPORTED)

# Create imported target unordered_multimapDict
add_library(unordered_multimapDict SHARED IMPORTED)

# Create imported target setDict
add_library(setDict SHARED IMPORTED)

# Create imported target unordered_setDict
add_library(unordered_setDict SHARED IMPORTED)

# Create imported target multisetDict
add_library(multisetDict SHARED IMPORTED)

# Create imported target unordered_multisetDict
add_library(unordered_multisetDict SHARED IMPORTED)

# Create imported target complexDict
add_library(complexDict SHARED IMPORTED)

# Create imported target valarrayDict
add_library(valarrayDict SHARED IMPORTED)

# Create imported target Cling
add_library(Cling SHARED IMPORTED)

# Create imported target rootcling
add_executable(rootcling IMPORTED)
...
# Create imported target rootd
add_executable(rootd IMPORTED)
...
# Create imported target pq2
add_executable(pq2 IMPORTED)
...
# Create imported target xpdtest
add_executable(xpdtest IMPORTED)
...
# Create imported target rootnb.exe
add_executable(rootnb.exe IMPORTED)
...
# Create imported target JupyROOT
add_library(JupyROOT SHARED IMPORTED)
...
# Create imported target TMVAGui
add_library(TMVAGui SHARED IMPORTED)
